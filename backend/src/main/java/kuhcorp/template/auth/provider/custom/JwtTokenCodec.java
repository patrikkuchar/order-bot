...
import kuhcorp.template.auth.AuthToken;
import kuhcorp.template.auth.AuthToken.ExpiredTokenException;
import kuhcorp.template.auth.AuthToken.InvalidTokenException;
import kuhcorp.template.auth.TokenCodec;
