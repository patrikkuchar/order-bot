...
import kuhcorp.orderbot.db.querydsl.filter.DecimalRange;
import kuhcorp.orderbot.db.querydsl.filter.ListFilter;
import kuhcorp.orderbot.domain.test.TestDtos.TestEntityDto;
import kuhcorp.orderbot.domain.test.TestDtos.TestItemDto;
import kuhcorp.orderbot.domain.test.TestEntity.Category;
...
import static kuhcorp.orderbot.domain.test.QTestEntity.testEntity;
