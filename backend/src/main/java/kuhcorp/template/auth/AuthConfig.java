...
import kuhcorp.template.auth.provider.custom.JwtTokenCodec;
import kuhcorp.template.auth.provider.custom.CustomUserProvider;
...
import static kuhcorp.template.api.ApiRoutes.*;
