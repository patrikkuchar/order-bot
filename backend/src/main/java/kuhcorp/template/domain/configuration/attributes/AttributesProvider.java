package kuhcorp.template.domain.configuration.attributes;

import com.querydsl.jpa.impl.JPAQuery;
import jakarta.persistence.EntityManager;
import kuhcorp.template.domain.configuration.attributes.Attributes.AttributeType;
import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Component;

import java.util.Optional;

import static kuhcorp.template.domain.configuration.attributes.QAttributes.attributes;
