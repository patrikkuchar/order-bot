...
import kuhcorp.template.domain.configuration.domain.DomainGuard;
import kuhcorp.template.domain.configuration.domain.DomainMapping;
...
import kuhcorp.template.domain.test.TestRepo.TestItemListFilter;
...
import static kuhcorp.template.domain.configuration.domain.Domains.TEST;
